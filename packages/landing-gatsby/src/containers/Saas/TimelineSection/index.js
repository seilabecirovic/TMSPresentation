...
import Illustration from 'common/src/assets/image/saas/illustration.svg';
...
const TimelineSection = ({
  ...
  return (
    <Box {...sectionWrapper}>
      <Container>
        <Box {...sectionHeader}>
          <Text {...sectionSubTitle} style={{color:"#A61E29"}} content="WORKING STEP" />
          <Heading
            {...sectionTitle}
            content="How Smart TMS works behind the scenes"
          />
        </Box>
        <Box {...row}>
          <Box {...col} {...imageArea}>
