...
const FeatureSection = ({
  ...
  return (
    <SectionWrapper id="feature_section">
      <Container>
        <Box {...secTitleWrapper}>
          <Text {...secText} content="EFFECTS" />
          <Heading
            {...secHeading}
            content="The most important effects of system application are:"
          />
        </Box>
          ...
          {Data.saasClassicJson.FEATURES.map((item, index) => (
            <Box {...col} key={`feature-item-${index}`} className="feature_col">
              <FeatureBlock
                ...
                iconPosition="left"
                title={<Heading  style={{color:"#A61E29"}} content={item.title} {...featureTitle} />}
                description={
